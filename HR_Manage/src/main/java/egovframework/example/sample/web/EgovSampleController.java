...
public class EgovSampleController {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/HRList.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/addMemberView.do", method = RequestMethod.GET)
	public String addMemberView(@ModelAttribute("searchVO") SampleDefaultVO searchVO, Model model) throws Exception {
