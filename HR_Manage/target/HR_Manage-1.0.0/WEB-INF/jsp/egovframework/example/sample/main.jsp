...
<head>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
    	...
    	// 디테일화면 (수정화면) 이동
         function fn_select(memberNo){
    		alert(memberNo);
        	location.href='/view.do?memberNo='+memberNo; 
        } 
	...
	<form:form commandName="searchVO" id="listForm" name="listForm" method="post">
        <div id="content_pop">
        	...
        	<div style="float:right;">
              	<img src="images/egovframework/example/all_icon.gif" width="11" height="11" align="absmiddle" /> 
               	  <a href="#">수정</a> 
                <img src="images/egovframework/example/all_icon.gif" width="11" height="11" align="absmiddle" /> 
               	  <a href="#">인사기록카드</a> 
                <img src="images/egovframework/example/all_icon.gif" width="11" height="11" align="absmiddle" /> 
        		...
        		<table width="100%" border="0" cellpadding="0" cellspacing="0" summary="카테고리ID, 케테고리명, 사용여부, Description, 등록자 표시하는 테이블">
        			...
        			<c:forEach var="result" items="${resultList}" varStatus="status">
            			<tr>
            				...
            				<td align="center" class="listtd"><a href="javascript:fn_select(${result.memberNo})"><c:out value="${result.memberKnm}"/></a></td>
        	...
        	<%-- <div id="sysbtn">
        	  <ul>
        	      <li>
        	          <span class="btn_blue_l">
        	              <a href="javascript:fn_Add();"><spring:message code="button.create" /></a>
                          <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
                      </span>
                  </li>
              </ul>
